...
class SplashActivity : AppCompatActivity() {
    ...
    {
        //WHEN ACTIVITY LAUNCHED SET THE LAYOUT BY SETCONTENTVIEW METHOD
            ...
            131 -> {
                if (grantResults.isNotEmpty() && grantResults[0] == PackageManager.PERMISSION_GRANTED
                    ...
                    Toast.makeText(this@SplashActivity,
                            "Please grant All the permission to continue", Toast.LENGTH_SHORT).show()
                    this.finish()
                }
                return
            }
            else -> {
                Toast.makeText(this@SplashActivity, "Somthing went worng", Toast.LENGTH_SHORT).show()
           this.finish()
                return
            }
        }
